...
namespace pixel_terrain::nbt {
    ...
    auto operator<<(std::ostream &out, enum nbt_path::pathspec::container cont)
        ...
        case nbt_path::pathspec::container::NONE:
            repr = "container::NONE";
            break;
        case nbt_path::pathspec::container::UNSPEC:
            repr = "container::UNSPEC";
            break;
...
BOOST_AUTO_TEST_CASE(index_only) {
    auto *p = nbt_path::compile("[1]");
    BOOST_TEST(p != nullptr);
    std::vector<nbt_path::pathspec> path = p->path();
    BOOST_TEST(path.size() == 1);
    BOOST_TEST(path[0].category() == nbt_path::pathspec::category::INDEX);
    BOOST_TEST(path[0].container() == nbt_path::pathspec::container::UNSPEC);
    BOOST_TEST(path[0].index() == 1);
    delete p;
}

BOOST_AUTO_TEST_CASE(indexed_access) {
    ...
    BOOST_TEST(path[1].container() == nbt_path::pathspec::container::UNSPEC);
...
BOOST_AUTO_TEST_CASE(compound_2) {
    ...
    BOOST_TEST(path[2].container() == nbt_path::pathspec::container::UNSPEC);
...
BOOST_AUTO_TEST_CASE(compound_3) {
    ...
    BOOST_TEST(path[3].container() == nbt_path::pathspec::container::UNSPEC);
...
BOOST_AUTO_TEST_CASE(list_container_specifier) {
    auto *p = nbt_path::compile("[L2][1]");
    BOOST_TEST(p != nullptr);
    std::vector<nbt_path::pathspec> path = p->path();
    BOOST_TEST(path.size() == 2);
    BOOST_TEST(path[0].category() == nbt_path::pathspec::category::INDEX);
    BOOST_TEST(path[0].container() == nbt_path::pathspec::container::LIST);
    BOOST_TEST(path[0].index() == 2);
    BOOST_TEST(path[1].category() == nbt_path::pathspec::category::INDEX);
    BOOST_TEST(path[1].container() == nbt_path::pathspec::container::UNSPEC);
    BOOST_TEST(path[1].index() == 1);
    delete p;
...
BOOST_AUTO_TEST_CASE(array_container_specifier) {
    auto *p = nbt_path::compile("[A2][1]");
    BOOST_TEST(p != nullptr);
    std::vector<nbt_path::pathspec> path = p->path();
    BOOST_TEST(path.size() == 2);
    BOOST_TEST(path[0].category() == nbt_path::pathspec::category::INDEX);
    BOOST_TEST(path[0].container() == nbt_path::pathspec::container::ARRAY);
    BOOST_TEST(path[0].index() == 2);
    BOOST_TEST(path[1].category() == nbt_path::pathspec::category::INDEX);
    BOOST_TEST(path[1].container() == nbt_path::pathspec::container::UNSPEC);
    BOOST_TEST(path[1].index() == 1);
...
BOOST_AUTO_TEST_CASE(container_specifier_mixed) {
    auto *p = nbt_path::compile("[A2][L1]");
    BOOST_TEST(p != nullptr);
    std::vector<nbt_path::pathspec> path = p->path();
    BOOST_TEST(path.size() == 2);
    BOOST_TEST(path[0].category() == nbt_path::pathspec::category::INDEX);
